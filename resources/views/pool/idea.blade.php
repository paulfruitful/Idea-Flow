...
<body class="block">
    ...
    <div class="grid justify-self-stretch justify-items-center mt-3 mb-6  bg-gradient-to-r from-cyan-500 to-blue-700 w-full" style="height: 400px">
      ...
      <p class="text-5xl text-white m-auto font-bold "><span class="">Keep The Cycle Of Ideas Flowing</span> </p>
      <p class="text-xl font-bold m-auto p-6 mb-4" style="color: #ffffff">Build The Next Solution By Implementing Ideas</p>
