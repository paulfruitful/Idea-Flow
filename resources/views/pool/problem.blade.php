...
<body class="block">
    ...
    <div class="grid justify-self-stretch justify-items-center mt-3 mb-6  bg-gradient-to-r from-red-500 to-red-700 w-full" style="height: 400px">
     ...
     <a href="/create/idea" class="p-4 m-auto hover:shadow-md hover:p-3 text-md  flex flex-row font-bold border-solid shadow-xl rounded-md bg-white text-black" >New Idea</a>
