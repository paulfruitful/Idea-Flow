...
<div class="grid justify-self-stretch justify-items-center mt-3 mb-6  bg-gradient-to-r from-green-300 to-green-700 w-full" style="height: 400px">
    ...
    <p class="text-md text-center lg:text-xl font-bold p-6 mb-4" style="color: #ffffff">{{$solution->tagline}}</p>
 ...
 <div class="justify-items-center flex flex-row m-auto">
  <a href="{{$solution->demo}}" class="p-4 mr-4 m-auto hover:shadow-md hover:p-3 text-md text-gray-800 flex flex-row font-bold border-solid shadow-xl rounded-md bg-black text-white">View Demo</a>
  </div>
