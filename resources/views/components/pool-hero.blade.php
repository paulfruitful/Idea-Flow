...
<p class="text-xl text-center lg:flex lg:flex-row   p-6 mb-4" style="color: #ffffff">Share Your Ideas <span class="flex-col lg:flex-row">, <span  class="p-3 lg:p-0 "> Offer Your Solutions, and</span> <span class="p-3 lg:p-0 "> Report Your Problems</span> </span> </p>
