...
<ul class="flex-col text-center lg:hidden p-4 mb-4" style="color: #ffffff" >
<li class="italic  text-lg">Share Your Ideas</li>
<li class="italic  text-lg">Offer Your Solutions </li>
<li class="italic  text-lg">Report Your Problems</li>
</ul>
<div class="justify-items-center flex flex-row m-auto">
<a href="/create/idea" class="p-4 mr-4 m-auto hover:shadow-md hover:p-3 text-md text-gray-800  flex-row font-bold border-solid shadow-xl rounded-md bg-black text-white" style=""><span class="text-white text-3xl font-bold">+</span> <span class="text-center">New Idea</span></a>
<a href="/create/solution" class="p-5 m-auto hover:shadow-md hover:p-3 text-md text-gray-800 flex flex-row font-bold border-solid shadow-xl rounded-md bg-white text-black" style="">
