...
<a href="/ideas/create" class="p-4 m-auto text-md hover:bg-transparent hover:text-white text-gray-800 flex flex-row font-bold border-solid shadow-xl rounded-md" style="background-color:#ffea00;"><svg style="width:15px; height:20px;" class="mt-1 ml-1 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg>New Idea</a>
