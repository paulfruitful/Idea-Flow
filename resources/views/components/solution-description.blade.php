...
<div class="flex mt-12 flex-col w-full p-6">
    ...
    <div class="grid m-3 mt-6">
      <div class="justify-self-start"><p class="text-md ">By <span class="font-bold">{{ucwords($solution->author)}}</span></p></div>
      <div class="justify-self-end"><span class="font-bold shadow-sm  text-black ">{{$solution->type=="combined"?"A Software X Hardware":'A' .' '. ucwords($solution->type)}}</span></div> 
      </div>
