...
<div class="flex flex-row sm:flex-column text-center" style="margin-top: -58px">
  <a href="/pools/ideas" class="text-md  font-bold p-3 hover:p-4 flex flex-nowrap flex-row hover:text-indigo-500 text-gray-800 hidden lg:flex">
  ...
  <a href="/user/{{auth()->user()->username}}" class="text-md  font-bold p-3 hover:p-4 flex flex-nowrap flex-row hover:text-indigo-500 text-gray-800 hidden lg:flex">
 ...
 <a href="" class="text-md font-bold p-3 hover:p-4 grid justify-self-end lg:hidden flex-row hidden lg:flex">
