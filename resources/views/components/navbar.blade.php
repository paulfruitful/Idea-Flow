...
<!-- Mobile View -->
<div class=" bg-white border-solid shadow-md  z-40 absolute  inset-y-0 left-0 p-8 m-auto  flex flex-col lg:hidden sm:hidden md:hidden xl:hidden text-center" id="navbar" style="margin-top:-25px; display:none; height:400px; width:200px;">
