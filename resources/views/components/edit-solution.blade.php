...
<div class="relative flex flex-row m-6">
  ...
  <input type="text" placeholder="Name e.g MediStar" class=" placeholder:italic placeholder:text-slate-400 block border-solid border-t-0 border-b-2 border-slate-600  focus:outline-none w-full focus:border-sky-500" style=" border-bottom-width:2.4px;" name="title" value="{{$solution->title}}">
</div>
<div class="relative flex flex-row m-7 ml-4">
  <label  class="text-xl pr-3">Tagline:</label>
  <input type="text" placeholder="A Solution To Solve " class=" placeholder:italic placeholder:text-slate-400 block border-solid border-t-0 border-b-2 border-slate-600  focus:outline-none w-full focus:border-sky-500" style=" border-bottom-width:2.4px;" name="tagline" value="{{$solution->tagline}}">
</div>
<div class="relative flex flex-row m-7 ml-4">
    <label  class="text-xl pr-3">Demo:</label>
    <input type="text" placeholder="https:// " class=" placeholder:italic placeholder:text-slate-400 block border-solid border-t-0 border-b-2 border-slate-600  focus:outline-none w-full focus:border-sky-500" style=" border-bottom-width:2.4px;" name="demo" value="{{$solution->demo}}">
  </div>
...
<div class="relative flex flex-col m-6 mt-6">
  <textarea placeholder="Idea to solve..." id="edit" class="  placeholder:italic placeholder:text-slate-400 block border-solid border-2 p-6 border-slate-400  focus:outline-none focus:border-sky-500" name="description" >{{$solution->description}}</textarea>
