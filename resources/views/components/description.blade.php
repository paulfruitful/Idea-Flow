...
<div class="justify-self-start"><span class="p-3 shadow-sm bg-black mb-12 text-white border-solid rounded">{{$idea->plan=="combined"?"Software X Hardware":ucwords($idea->plan)}}</span></div> 
</div>
