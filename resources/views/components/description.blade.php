...
<div class="justify-self-start"><span class="p-3 shadow-sm bg-gradient-to-r from-cyan-500 to-blue-700 m-6 text-white border-solid rounded">{{$idea->plan=="combined"?"Software X Hardware":ucwords($idea->plan)}}</span></div> 
</div>
