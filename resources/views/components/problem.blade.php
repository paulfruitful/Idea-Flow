...
<a class="flex flex-row hover:text-red-600 active:text-red-600 hover:px-3 " href="/problems/{{$problem->id}}">Learn more <img src="https://cdn-icons-png.flaticon.com/512/2989/2989988.png" style="height: 30px; width:30px;" alt=""> </a>
</div>
</div>
</div>
</a>
