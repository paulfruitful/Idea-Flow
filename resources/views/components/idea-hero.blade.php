...
<div class="grid justify-self-stretch justify-items-center mt-3 mb-6  bg-gradient-to-r from-cyan-500 to-blue-700 w-full" style="height: 400px">
    ...
    <p class="text-3xl lg:text-5xl text-center text-white m-auto font-bold "><span class="">{{$idea->title}}</span></p>
    <p class="text-md text-center lg:text-xl font-bold p-6 mb-4" style="color: #ffffff">{{$idea->tagline}}</p>
