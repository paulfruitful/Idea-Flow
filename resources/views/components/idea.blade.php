...
<div class="text-center flex flex-row flex-row-reverse p-6 text-blue-600 text-md"><img src="https://cdn-icons-png.flaticon.com/512/9135/9135999.png" style="height: 30px; width:30px;" alt="">{{$idea->tagline}} </div>
